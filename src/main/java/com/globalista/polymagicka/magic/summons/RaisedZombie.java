...
public class RaisedZombie extends IronGolemEntity implements PolymerEntity {

    private int attackTicksLeft;
    private int lookingAtVillagerTicksLeft;


    public RaisedZombie(EntityType<? extends IronGolemEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createAttributes() {
        return MobEntity.createMobAttributes().add(EntityAttributes.MAX_HEALTH, (double)40.0F)
                ...
                .add(EntityAttributes.ARMOR, (double)2.0F);
    }
    ...
    public boolean damage(ServerWorld world, DamageSource source, float amount) {
        ...
        this.playSound(SoundEvents.ENTITY_ZOMBIE_HURT, 1.0F, 1.0F);
        return bl;
    }
    ...
    public void handleStatus(byte status) {
        if (status == 4) {
            ...
            this.playSound(SoundEvents.ENTITY_ZOMBIE_AMBIENT, 1.0F, 1.0F);
        } else if (status == 11) {
    ...
    protected void playStepSound(BlockPos pos, BlockState state) {
        this.playSound(SoundEvents.ENTITY_ZOMBIE_STEP, 1.0F, 1.0F);
    }
    ...
    public void playAmbientSound() {
        this.playSound(SoundEvents.ENTITY_ZOMBIE_AMBIENT);
    }
