...
public class GreaterFamiliar extends IronGolemEntity implements PolymerEntity {

    private int attackTicksLeft;
    private int lookingAtVillagerTicksLeft;


    public GreaterFamiliar(EntityType<? extends IronGolemEntity> entityType, World world) {
    ...
    public boolean damage(ServerWorld world, DamageSource source, float amount) {
        ...
        this.playSound(SoundEvents.ENTITY_POLAR_BEAR_HURT, 1.0F, 1.0F);
        return bl;
    }
    ...
    public void handleStatus(byte status) {
        if (status == 4) {
            ...
            this.playSound(SoundEvents.ENTITY_POLAR_BEAR_AMBIENT, 1.0F, 1.0F);
        } else if (status == 11) {
    ...
    protected void playStepSound(BlockPos pos, BlockState state) {
        this.playSound(SoundEvents.ENTITY_POLAR_BEAR_STEP, 1.0F, 1.0F);
    }
    ...
    public void playAmbientSound() {
        this.playSound(SoundEvents.ENTITY_POLAR_BEAR_AMBIENT);
    }
