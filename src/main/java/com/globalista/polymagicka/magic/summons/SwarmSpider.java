...
public class SwarmSpider extends IronGolemEntity implements PolymerEntity {

    private int attackTicksLeft;
    private int lookingAtVillagerTicksLeft;


    public SwarmSpider(EntityType<? extends IronGolemEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createAttributes() {
        return MobEntity.createMobAttributes().add(EntityAttributes.MAX_HEALTH, (double)5.0F)
    ...
    public boolean tryAttack(ServerWorld world, Entity target) {
        ...
        if (bl) {
            ...
            if (target instanceof LivingEntity) {
                ((LivingEntity)target).addStatusEffect(new StatusEffectInstance(StatusEffects.POISON, 4 * 20, 0), this);
            }
        }
    ...
    protected void playStepSound(BlockPos pos, BlockState state) {
        this.playSound(SoundEvents.ENTITY_SPIDER_STEP, 1.0F, 1.0F);
    }
    ...
    public void playAmbientSound() {
        this.playSound(SoundEvents.ENTITY_SPIDER_AMBIENT);
    }
