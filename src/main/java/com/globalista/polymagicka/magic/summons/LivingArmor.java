...
public class LivingArmor extends IronGolemEntity implements PolymerEntity {

    private int attackTicksLeft;
    private int lookingAtVillagerTicksLeft;


    public LivingArmor(EntityType<? extends IronGolemEntity> entityType, World world) {
    ...
    public boolean damage(ServerWorld world, DamageSource source, float amount) {
        ...
        this.playSound(SoundEvents.BLOCK_IRON_BREAK, 1.0F, 1.0F);
        return bl;
    }
    ...
    public void handleStatus(byte status) {
        if (status == 4) {
            ...
            this.playSound(SoundEvents.BLOCK_IRON_STEP, 1.0F, 1.0F);
        } else if (status == 11) {
    ...
    public void playAmbientSound() {
        this.playSound(SoundEvents.BLOCK_IRON_STEP);
    }
