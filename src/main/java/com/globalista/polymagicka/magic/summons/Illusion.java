...
public class Illusion extends IronGolemEntity implements PolymerEntity {
    ...
    public Illusion(EntityType<? extends IronGolemEntity> entityType, World world) {
    ...
    public boolean damage(ServerWorld world, DamageSource source, float amount) {
        ...
        this.playSound(SoundEvents.ENTITY_PLAYER_HURT, 1.0F, 1.0F);
        return bl;
    }
    ...
    protected void playStepSound(BlockPos pos, BlockState state) {
        ...
        this.playSound(stepSound, soundGroup.getVolume() * 0.15F, soundGroup.getPitch());
    }
    ...
    public void playAmbientSound() {
        this.playSound(SoundEvents.ENTITY_VILLAGER_AMBIENT);
    }
